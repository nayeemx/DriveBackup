...
- **Latest released version: v0.1.36** — live on GitHub
  https://github.com/nayeemx/DriveBackup/releases/tag/v0.1.36
  (DriveBackup-Setup-0.1.36.exe, 51.4 MB, state=uploaded, released 2026-08-25).
