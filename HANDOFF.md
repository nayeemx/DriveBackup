...
- **Latest released version: v0.1.38** — live on GitHub
  https://github.com/nayeemx/DriveBackup/releases/tag/v0.1.38
  (DriveBackup-Setup-0.1.38.exe, 51.4 MB, state=uploaded, released 2026-08-25).
- v0.1.38 properly fixes Material Icons rendering by enforcing `.q-icon, .material-icons { font-family: 'Material Icons' !important; }` globally in app CSS, bypassing typography class overrides.
- v0.1.37 fixes Material Icons font not loading (icons were showing as text).
- v0.1.36 fixes UI overflow, hover, table heights, and updates Help page.
- v0.1.35 fixes console minimize button.
- v0.1.34 fixes verify hash mismatch, Google Photos remote detection, adds gphotosdl proxy.
